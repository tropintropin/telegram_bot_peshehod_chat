...
graph LR
    ...
    id0 --> id8[(База данных<br>пользователей)]
    id0 --> id2{{ЧАВо}}
        id2 -.-> id20>Оплата и бронирование]
        id2 -.-> id21>Места встреч]
        id2 -.-> id22>Как проходит экскурсия]
        id2 -.-> id23>Ваши экскурсии<br>и отзывы]
            id23 -.->|???| id232>fa:fa-calendar-alt<i>График экскурсий<br>на неделю</i>]
            id23 -.->|???| id230>fa:fa-umbrella<i>Прогноз погоды</i>]
            id23 -..->|<i>Переход в раздел туров</i>| id7
    id0 --> id7{{Список всех<br>экскурсий}}
        id7 -.-> id71>Групповые]
        id7 -.-> id72>Индивидуальные]
    id0 --> id3(Контакты)
    id0 --> id4(Оставить отзыв)
    id0 --> id5(Анкета:<br>подбери себе тур)
        id5 -..->|<i>Переход в раздел туров</i>| id7
    id0 --> id6(Викторина)
```